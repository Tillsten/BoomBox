...
class ImageLabel(QtGui.QWidget):
    def __init__(self, text, image_path, parent=None):
        ...
        self.pic.setStyleSheet( "background-color: rgb(255,255,255); margin:5px; border:1px solid rgb(0, 0, 0); ")
...
class Tab_view(QtGui.QWidget):
    def __init__(self, parent=None):
        ...
        self.hsublay = QtGui.QHBoxLayout()
        self.total = QtGui.QLabel(u'Summe: 0,00 €')
        self.sub_total = QtGui.QLabel(u'Teilsumme: 0,00 €')
        self.hsublay.addWidget(self.total)
        self.hsublay.addWidget(self.sub_total)
        lay.addLayout(self.hsublay)
...
class Clients_view(QtGui.QWidget):
    ...
    def selected_tab_changed(self, new_item, old_item):
